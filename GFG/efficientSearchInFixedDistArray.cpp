...
int main(){
    vector<int> vec {-5,-6,-4,-3,-4,-3,-2,-1,0,-1,-2,-1,-2,-1,0,1,2,1,2,3,4,5,4,3,4,5,6,5,6,7,8,9,8,7,6,5,4};
    int searchKey = 0;
    cout << efficientSearch(vec,searchKey) << " is the lowest index where " << searchKey << " is found!" << endl;
